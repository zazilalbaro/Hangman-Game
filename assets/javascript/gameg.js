...
document.getElementById("newGame").addEventListener("click", function() {
	...
	// console.log(baby, noChar, remainingGuesses, wordChar)
	...
	document.onkeyup = function(event) {
		...
		var progress = [];
			...
			console.log(userGuess, noChar, baby, "remaining guesses:",remainingGuesses, "correctguesses:", correctGuesses);
		
		if (remainingGuesses = 0) {
			alert("Sorry, try again");
			losses++;
			document.getElementById("word").innerHTML = baby;
		}	
		else if (correctGuesses < noChar) {
